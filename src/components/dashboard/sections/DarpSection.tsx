...
import { UnfiledDarpDialog } from "../UnfiledDarpDialog";
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between">
            <div>
              ...
              <div className="flex items-center mt-3">
                <span className="text-4xl font-semibold text-orange-600">{clients.length}</span>
                <div className="ml-4">
            ...
            <Button 
              variant="outline" 
              className="mt-4 md:mt-0 border-orange-300 hover:bg-orange-50 hover:text-orange-700" 
