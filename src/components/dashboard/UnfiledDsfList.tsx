...
const UnfiledDsfList = () => {
      ...
      <Card className="border-[3px] border-blue-400 shadow-md animate-pulse">
        <CardHeader className="pb-2">
          <CardTitle className="text-base sm:text-lg flex items-center">
            ...
            <span className="hidden sm:inline">Liste des DSF non déposées</span>
            <span className="sm:hidden">DSF non déposées</span>
          </CardTitle>
        </CardHeader>
        <CardContent>
  ...
  return (
    <Card className="border-[3px] border-blue-400 shadow-lg overflow-visible">
      <CardHeader className="pb-2 bg-blue-50 px-3 sm:px-6">
        <CardTitle className="text-base sm:text-lg flex items-center">
          <FileText className="h-4 w-4 sm:h-5 sm:w-5 mr-2 text-blue-500 shrink-0" />
          <span className="hidden sm:inline">Liste des DSF non déposées ({clients.length})</span>
          <span className="sm:hidden">DSF non déposées ({clients.length})</span>
        </CardTitle>
      </CardHeader>
