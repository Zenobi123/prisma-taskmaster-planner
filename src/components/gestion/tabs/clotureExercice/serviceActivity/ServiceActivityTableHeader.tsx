  ...
  return (
    <TableHeader className="bg-primary text-white">
      <TableRow className="border-b-2 border-black">
        ...
        <TableHead rowSpan={2} className="text-center text-white font-medium border-r-2 border-black w-24">DE</TableHead>
        <TableHead rowSpan={2} className="text-center text-white font-medium border-r-2 border-black w-28">Montant TTC</TableHead>
        <TableHead rowSpan={2} className="text-center text-white font-medium w-20">Actions</TableHead>
      </TableRow>
      <TableRow className="border-b-2 border-black">
        <TableHead className="text-center text-white font-medium border-r-2 border-black w-32">Principal (5%)</TableHead>
